            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" action="{{ route('admin.login') }}" method="post" class="mb-3" >
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember-me"> <a href="{{ route('admin.ShowRegister') }}"> Create New Account </a> </label>
                                </div>
                            </div>
                            <div class="mb-3">
